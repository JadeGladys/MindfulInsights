...
const Menu = () => {
    return(
    <div className="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-menu">
      <div className="offcanvas-md offcanvas-end" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div className="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          ...
          <ul className="nav nav-pills flex-column mb-auto">
            ...
            <a href="/dashboard" className="nav-link d-flex align-items-center gap-2" aria-current="page">
            ...
            <li className="nav-item">
            <a href="/workspace" className="nav-link d-flex align-items-center gap-2">
            ...
            <li className="nav-item">
            <a href="/collaboration" className="nav-link d-flex align-items-center gap-2">
            ...
            <li className="nav-item">
            <a href="/PbResearch" className="nav-link d-flex align-items-center gap-2">
            ...
            <li className="nav-item">
            <a href="/tasks" className="nav-link d-flex align-items-center gap-2">
