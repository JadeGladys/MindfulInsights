...
const AnalystMenu = () => {
    return(
    <div className="sidebar col-md-3 col-lg-2 p-0 bg-body-menu" style={{backgroundColor: "#000000"}}>
      <div className="offcanvas-md offcanvas-end" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div className="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          ...
          <ul className="nav nav-pills flex-column mb-auto">
            ...
            <a href="/ADashboard" className="nav-link d-flex align-items-center gap-2" aria-current="page" style={{color: "white"}}>
            ...
            <li className="nav-item">
            <a href="/Atasks" className="nav-link d-flex align-items-center gap-2" style={{color: "white"}}>
            ...
            <li className="nav-item">
            <a href="/tools" className="nav-link d-flex align-items-center gap-2" style={{color: "white"}}>
            ...
            <li className="nav-item">
            <a href="#" className="nav-link d-flex align-items-center gap-2" style={{color: "white"}}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-file-earmark-ppt-fill" viewBox="0 0 16 16">
          ...
          <h6 className="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-body-secondary text-uppercase" style={{color: "lightgray"}}>
              <span>Settings tools</span>
          </h6>
          
          <ul className="nav flex-column mb-auto">
              <li className="nav-item">
              <a className="nav-link d-flex align-items-center gap-2" style={{color: "white"}} href="#">
              ...
              <li className="nav-item">
              <a className="nav-link d-flex align-items-center gap-2" style={{color: "white"}} href="/login">
